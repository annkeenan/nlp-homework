...
class Node(object):
    ...
    def unbigram(self):
        for child in self.children:
            child.unbigram()
            if child.children:
                child.label = child.label.split('-')[1]
    ...
    def trigram(self):
        for child1 in self.children:
            ...
            for child2 in child1.children:
                if child2.children:
                    child2.label = child1.parent.label + '-' + child1.label + '-' + child2.label
    ...
    def untrigram(self):
        for child1 in self.children:
            ...
            for child2 in child1.children:
                if child2.children:
                    child2.label = child2.label.split('-')[2]
        ...
        for child in self.children:
            ...
            if child.order == 1:
                if '>' not in child.label:
                    pair_label = child.parent.children[0].label
                    child.parent.children[0].label += '<' + child.label
                    child.label += '>' + pair_label

    def unpair(self):
        for child in self.children:
            child.unpair()
            if child.order == 1:
                child.parent.children[0].label = child.parent.children[0].label.split('<')[0]
