...
def score(stats, n=4):
    ...
    b = 1.
    for i in range(1, n + 1):
        b *= stats['match', i] / stats['guess',
                                       i] if stats['guess', i] > 0 else 0
    b **= 0.25
...
if __name__ == "__main__":
    ...
    argparser.add_argument('test', metavar='predict',
                           help='predicted translations')
    argparser.add_argument('gold', metavar='true', help='true translations')
    argparser.add_argument(
        '-n', help='maximum n-gram size to score', default=4, type=int)
